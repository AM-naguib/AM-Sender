                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex flex-column h-100">
                            <div class="row">
                                <div class="col-md-6">
                                    <a href="{{ route('panel.devices.index') }}" style="text-decoration: none;">
                                ...
                                <div class="col-md-6">
                                    <a href="{{ route('panel.messages.index') }}" style="text-decoration: none;">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        ...
                                                        <h2 class="mt-4 ff-secondary fw-semibold"><span
                                                                class="counter-value"
                                                                data-target="{{ $messages }}">0</span></h2>
                                                        <p class="mb-0 text-muted"><span
                                ...
                                <div class="col-md-6">
                                    <a href="{{ route('panel.contacts.index') }}" style="text-decoration: none;">
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        ...
                                                        <h2 class="mt-4 ff-secondary fw-semibold"><span
                                                                class="counter-value"
                                                                data-target="{{ $contacts }}">0</span></h2>
                                                        <p class="mb-0 text-muted"><span
                                                                class="badge bg-light text-danger mb-0">
                                                            </span>
                                                        </p>
                                ...
                                <div class="col-md-6">
                                    <a href="{{ route('panel.message-templates.index') }}" style="text-decoration: none;">
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        ...
                                                        <h2 class="mt-4 ff-secondary fw-semibold"><span
                                                                class="counter-value"
                                                                data-target="{{ $message_templates }}">0</span></h2>
                                                        <p class="mb-0 text-muted"><span
                                                                class="badge bg-light text-danger mb-0">
                                                            </span>
                                                        </p>
