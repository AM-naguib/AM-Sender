                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <form action="{{ route('panel.contracts.update', $contract) }}" method="POST">
                                        @csrf
                                        @method("PUT")
                                        <div class="col-md-4 col-12 mx-auto">
                                            <div class="mb-3">
                                                ...
                                                <input name="name" id="name" class="form-control"
                                                    placeholder="Enter Contract Name" required value="{{ $contract->name }}">
                                            </div>
                                            <div class="mb-3">
                                                <label for="name" class="form-label">Phone</label>
                                                <input name="phone" id="name" class="form-control"
                                                    placeholder="Enter Contract Phone" required value="{{ $contract->phone }}">
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="contract_group_id" id="" class="form-select">
                                                    ...
                                                    @foreach ($contractGroups as $group)
                                                        <option {{ $contract->contract_group_id == $group->id ? 'selected' : '' }} value="{{ $group->id }}">{{ $group->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
