...
<!-- Mirrored from themesbrand.com/velzon/html/material/auth-signin-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 14:19:35 GMT -->
<head>
                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="index.html" class="d-inline-block auth-logo">
                                    <img src="{{ asset('panel') }}/images/logo-light.png" alt="" height="20">
                                </a>
                            </div>
...
@csrf
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="username" placeholder="Enter username" value="admin" name="username">
                                        </div>
    ...
    <!-- particles js -->
    <script src="{{ asset('panel') }}/libs/particles.js/particles.js"></script>
    <!-- particles app js -->
    <script src="{{ asset('panel') }}/js/pages/particles.app.js"></script>
    <!-- password-addon init -->
    <script src="{{ asset('panel') }}/js/pages/password-addon.init.js"></script>
</body>
